 ...
 * @author Axs
 */
public class ControleManterAlunoTest {
    
    public ControleManterAlunoTest() {
    }
    ...
    /**
     * Test of getInstance method, of class ControleManterAluno.
     */
    @Test
    public void testGetInstance() {
        System.out.println("getInstance");
        ControleManterAluno result = ControleManterAluno.getInstance();
        assertNotNull(result);
    }

    /**
     * Test of cadastrarAluno method, of class ControleManterAluno.
     */
    @Test
    public void testCadastrarAluno() throws Exception {
        System.out.println("cadastrarAluno");
        String alunoNome = "Mateus Medeiros Furquim Mendonca";
        String alunoMatricula = "110017561";
        String alunoCurso = "Engenharia de Software";
        String alunoSemestre = "";
        ...
        if (!ControleManterAluno.getInstance().cadastrarAluno(
                alunoNome,
                alunoMatricula,
                alunoCurso,
                alunoSemestre,
                listaDisciplinas))
        {
            fail("Não foi possível cadastrar aluno!");
        }
        // TODO review the generated test code and remove the default call to fail.
    }

    /**
     * Test of obterAluno method, of class ControleManterAluno.
     */
    @Test
    public void testObterAluno() throws Exception {
        System.out.println("obterAluno");
        Aluno result = ControleManterAluno.getInstance().obterAluno();
        assertNotNull(result);
    }
}
