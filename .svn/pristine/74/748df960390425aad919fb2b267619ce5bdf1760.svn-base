 ...
 */
package DisciplinasCursadas.DAO;
...
public class XmlDisciplinasCursadas {
    ...
    public static ArrayList lerXml() {
    ...
    public static boolean excluiXmlCadastro() {
        boolean sucesso=false;
        File FILE = new File("XML/DisciplinasCursadas.xml");
        try {
            sucesso = FILE.delete();
            //JOptionPane.showMessageDialog(null, "Disciplina "+ sucesso);
            return sucesso;
        } catch (Exception e) {
            e.printStackTrace();
            return sucesso;
