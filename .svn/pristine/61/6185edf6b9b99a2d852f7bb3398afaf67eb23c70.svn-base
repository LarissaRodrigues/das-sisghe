...
public class InAluno extends javax.swing.JFrame {
    ...
    private void jBCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBCadastrarActionPerformed
        ...
        // *Beatriz*
        ControlaDisciplina.chamaDeserializar();
        this.dispose();
    ...
    private void jBAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAlterarActionPerformed
        ...
        ControlaAluno Caluno = new ControlaAluno();
        ...
        ControlaDisciplina.chamaDeserializarCursadas();
        //cd.setaDisciplina();
        cd.listaAltera();
        cd.setaDisciplina();
        ControlaDisciplina.chamaDeserializar();
    ...
    private void jBExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBExcluirActionPerformed
        boolean sucesso;
        sucesso = ControlaAluno.chamaExcluir();
        JOptionPane.showMessageDialog(null, "Exclusão efetuada" +(sucesso ? (" com sucesso!") : (" incorretamente! ERRO")));
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InAluno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
