...
import DisciplinasCursadas.Controle.*;
...
public class InAlteraAluno extends javax.swing.JFrame {
    ...
    private void jBalterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBalterarActionPerformed
        ...
        cd.verificarAlteracao();
        cd.chamaSerializarAlteracao();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InAlteraAluno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        //</editor-fold>
        InAlteraAluno cadastro = new InAlteraAluno();
        cadastro.setVisible(true);
        // cadastro.setaDados("david", null, null, null);
        /* Create and display the form */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InAlteraAluno().setVisible(true);
            }
        });
    }
